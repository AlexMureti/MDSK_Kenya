...
<head>
  ...
  <link rel="icon" href="brand/logo/mdsk-emblem.svg" type="image/svg+xml" />
  <link rel="icon" href="assets/optimized/mdsk-emblem-320.png" type="image/png" sizes="320x320" />
  <link rel="apple-touch-icon" href="assets/optimized/mdsk-emblem-320.png" />
